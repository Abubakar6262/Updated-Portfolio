          ...
          <div className="w-full md:w-1/2 flex justify-center self-start">
            <div className="rounded-xl  overflow-hidden relative text-center p-10 group items-center flex flex-col max-w-sm hover:shadow-2xl transition-all duration-500 shadow-xl about-card glass dark:border-gray-600 ">
              ...
              <div className="text-gray-500 group-hover:scale-105 transition-all">
                <div className="relative w-48 m-1">
                  <Image
                    src={myprofile}
                    alt="author"
                    className="object-cover rounded-x2 cursor-pointer uppercase px-4 py-2 active:translate-x-0.5 active:translate-y-0.5 hover:shadow-[0.5rem_0.5rem_hsl(var(--primary)),-0.5rem_-0.5rem_black] dark:hover:shadow-[0.5rem_0.5rem_hsl(var(--primary)),-0.5rem_-0.5rem_white]  transition"
                    height={300}
                    width={276}
                  />
                </div>
              ...
              <div className="group-hover:pb-10 transition-all duration-500 delay-200 mt-12">
                <h1 className="font-semibold text-gray-700 dark:text-white">Muhammad Abu Bakkar</h1>
              ...
              <div className="flex items-center transition-all duration-500 delay-200 group-hover:bottom-3 -bottom-full absolute gap-2 justify-evenly w-full">
                <div className="flex gap-3 text-2xl bg-gray-700 text-white p-1 hover:p-2 transition-all duration-500 delay-200 rounded-full shadow-sm">
                  <a href="https://github.com/Abubakar6262" target="_blank" rel="noopener noreferrer" className="hover:scale-110 cursor-pointer transition-all duration-500 delay-200">
                    <AiFillGithub />
                  </a>
            ...
            <div className={`w-full h-auto relative top-[20px] p-[10px] mb-[30px] md:mb-0 md:top-0`}>
              ...
              <div className={`relative top-[20px]`}>
                ...
                <div className="p-4 text-[15px] text-white-200 px-5 bg-dark-400 border-solid">
                  ...
                  <p className="text-lg border-l-green-200 p-4 text-[15px] text-white-200 px-5 bg-dark-400 border-solid">
                    🌸 I believe that a great developer isn&apos;t just about writing code; it&apos;s about understanding the problem, architecting elegant solutions, and continuously learning to stay at the cutting edge of technology.
                  </p>
                  <p className="text-lg border-l-green-200 p-4 text-[15px] text-white-200 px-5 bg-dark-400 border-solid">
                    🗺️ I&apos;m excited about the opportunity to collaborate with visionary teams and organizations that share a passion for innovation and the drive to change the world through technology.
                  </p>
                  <p className="text-lg border-l-green-200 p-4 text-[15px] text-white-200 px-5 bg-dark-400 border-solid">
